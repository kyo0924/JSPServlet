		...
		<table>
			...
			<tr>
				...
				<td><input type="tel" placeholder="(-없이)01012345678"
					name="phone" id="phone" maxlength="11" required value="<%=m.getPhone()%>"/></td>
			</tr>
			<tr>
				<th>성별</th>
				<td><input type="radio" name="gender" id="gender0" value="M"
					...
					<input type="radio"
					name="gender" id="gender1" value="F" <%=m.getGender().equals("F")? "checked" : "" %>/><label for="gender1">여</label>
				</td>
			</tr>
			<tr>
				<th>주소</th>
			...
			<tr>
				<th>취미</th>
				<td><input type="checkbox" name="hobby" id="hobby0" value="독서" <%=checkHobby[0] %>/><label
					for="hobby0">독서</label> <input type="checkbox" name="hobby"
					id="hobby1" value="꽃꽂이" <%=checkHobby[1] %>/><label for="hobby1">꽃꽂이</label> <input
					type="checkbox" name="hobby" id="hobby2" value="십자수" <%=checkHobby[2] %>/><label
					for="hobby2">십자수</label><br> <input type="checkbox"
					name="hobby" id="hobby3" value="게임" <%=checkHobby[3] %>/><label for="hobby3">게임</label>
					<input type="checkbox" name="hobby" id="hobby4" value="승마" <%=checkHobby[4] %>/><label
					for="hobby4">승마</label> <input type="checkbox" name="hobby"
